...
log_file_path = args.result_dir + f"/results/fixed_log_{args.counter}.out"
...
def run_evaluation(model, enc):
    ...
    for bb_id, bb in tqdm(enumerate(range(len(batch_start)-1)), total=len(batch_start)-1):
        ...
        geo_pred = preds > args.fixed_thres
...
def report(results):
        ...
        results_file = args.result_dir + '/fixed_mean_f1_scores.csv'
