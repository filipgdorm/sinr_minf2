...
log_file_path = args.result_dir + f"/results/continuous_log_{args.counter}.out"
...
def run_evaluation(model, enc):
    ...
    df.to_csv("../report_plotting/geo_prior_plot_basic.csv")
...
def report(results):
        ...
        results_file = args.result_dir + '/continuous_mean_f1_scores.csv'
