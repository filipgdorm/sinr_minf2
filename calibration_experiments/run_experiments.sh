...
experiment_names=("an_full_-1" "an_full_1000" "an_slds_1000" "an_ssdl_1000")
model_paths=("1000_cap_models/final_loss_an_full_input_enc_sin_cos_hard_cap_num_per_class_-1/model.pt" \
            "1000_cap_models/final_loss_an_full_input_enc_sin_cos_hard_cap_num_per_class_1000/model.pt" \
